...
void init()
{
	...
	if (interactive(ob) && ob->query_temp("songxin_ok") &&
	...
	if (interactive(ob) && !environment(ob)->query("no_fight") &&
		...
		!(me->query_temp("zuji_target")!=t_name)))
	{
		me->set_temp("apply/attack",  random(40));
		me->set_temp("apply/defense", random(30));
		me->set_temp("apply/damage",  random(30));
		me->set_temp("apply/dodge",  100+random(80));
...
/* copy entire dbase values */
	...
	me->set("jiali",(int)(number*3/4)-random(30));
