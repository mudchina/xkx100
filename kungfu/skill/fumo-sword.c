...
mapping *action = ({
([	"action" : "$N一式"MAG"「穿云势」"NOR"，剑锋平指，剑势如风，一气呵成横扫$n的腰间",
	"lvl" : 0,
	"skill_name" : "穿云势"
]),
([	"action" : "$N向前跃上一步，左手剑诀，右手$w使出一式"HIC"「破雾势」"NOR"直刺$n的$l",
	"lvl" : 10,
	"skill_name" : "破雾势"
]),
([	"action" : "$N拔步挺腰，一式"HIB"「推山势」"NOR"，手中$w沉滞无比，缓缓挥剑撞向$n的$l",
	"lvl" : 20,
	"skill_name" : "推山势"
]),
...
([	"action" : "$N回身拧腰，右手虚抱成圆，一式"GRN"「开天势」"NOR"，$w中宫直进，刺向$n的胸口",
	"lvl" : 40,
	"skill_name" : "开天势"
]),
...
([	"action" : "$N运气施出"HIM"「雷针势」"NOR"，$w剑尖逼出一道青芒，闪电般破空射向$n的$l",
	"lvl" : 57,
	"skill_name" : "雷针势"
]),
([	"action" : "$N双腿半屈半蹲，一式"BLU"「龙吞势」"NOR"，剑尖划出无数圆圈，狂风骤起，笼罩天地",
	"lvl" : 64,
	"skill_name" : "龙吞势"
]),
});
